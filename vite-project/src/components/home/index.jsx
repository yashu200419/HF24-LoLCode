              ...
              <div className="row">
                <div className="col-lg-8 col-12 mx-auto">
                  ...
                  <h6 className="text-center">
                    Your comprehensive destination for forest and urban
                    analysis. Discover the convenience of uploading tree images
                    to generate detailed reports, obtain statistics, and
                    classify species.
                  </h6>
                  <form
                    method="get"
                    ...
                    >
                      ...
                      <li>
                        ...
                        <p className="text-white">
                          ...
                          and precise climate change analysis, offering
                          efficiency and accuracy in environmental management.
                        </p>
                      ...
                      <li>
                        ...
                        <p className="text-white">
                          ...
                          forest land diversion, urban well-being contributing
                      ...
                      <li>
                        ...
                        <p className="text-white">
                          ...
                          efficient image analytics solution, processing
                          satellite and aerial imagery for precise tree
                          enumeration. Environmental Stewardship: By employing
                          technology to automate tree counting ensures
                          responsible land use for developmental projects.
                        </p>
                        <div className="icon-holder">
                          <i className="bi-book" />
                        </div>
